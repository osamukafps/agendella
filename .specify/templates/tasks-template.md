...
**Tests**: Automated tests are REQUIRED for any feature that touches tenant isolation,
authorization, scheduling, timezone, duration, cancellation, or customer privacy. Other tests
should be included whenever they materially reduce delivery risk.
...
- [ ] T001 Update `specs/[###-feature-name]/spec.md` with the latest behavior, acceptance scenarios, and constitutional constraints
...
- [ ] T006 [P] Implement tenant resolution and default data scoping across persistence and API layers
- [ ] T007 [P] Implement authentication and server-side authorization framework
- [ ] T008 [P] Setup API routing and middleware structure
- [ ] T009 Create base models/entities that all stories depend on
- [ ] T010 Configure error handling, privacy-safe logging, and audit-relevant events
- [ ] T011 Setup environment configuration management
- [ ] T012 Define the scheduling invariants and concurrency protections required by this feature
...
### Tests for User Story 1 (MANDATORY when constitutional rules are affected) ⚠️
...
- [ ] T015 [P] [US1] Add or update automated coverage for tenant, authorization, scheduling, timezone, cancellation, or privacy rules touched by this story
...
- [ ] T021 [US1] Add privacy-safe logging and audit handling for user story 1 operations
...
### Tests for User Story 2 (MANDATORY when constitutional rules are affected) ⚠️
...
- [ ] T024 [P] [US2] Add or update automated coverage for tenant, authorization, scheduling, timezone, cancellation, or privacy rules touched by this story
...
### Tests for User Story 3 (MANDATORY when constitutional rules are affected) ⚠️
...
- [ ] T031 [P] [US3] Add or update automated coverage for tenant, authorization, scheduling, timezone, cancellation, or privacy rules touched by this story
...
- [ ] TXXX Validate responsive behavior on mobile and desktop browsers
...
- Update the specification before implementing behavior changes
- Verify required tests fail before implementing
- Keep tenant scoping and server-side authorization explicit in task descriptions
